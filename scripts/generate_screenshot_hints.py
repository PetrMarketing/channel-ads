...
PROMPT_TMPL = """Ты помогаешь админу сервиса MAX Маркетинг понять, что должно
быть на скриншоте.
...
ВАЖНО — правильные названия:
- Сервис/админка → «MAX Маркетинг» (НЕ «PK Business», НЕ «PKMarketing»)
- Бот в MAX → «ПКРеклама»
- Домен личного кабинета → max.pkmarketing.ru
...
- "Дашборд MAX Маркетинг на max.pkmarketing.ru → раздел «Аналитика»"

Если в slug упоминается pk-business / lk / dashboard / admin — это скрин
личного кабинета сервиса MAX Маркетинг (домен max.pkmarketing.ru).
Иначе — скрин самого MAX-приложения.
