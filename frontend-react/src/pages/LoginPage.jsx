  ...
  return (
    <div className="auth-wrapper" style={{
      ...
      <div style={{
        ...
        {!showMerge ? (
          <>
            <h1 style={{ fontSize: '1.5rem', marginBottom: '8px' }}><img src="/logo-64.png" alt="PK" style={{ width: 32, height: 32, borderRadius: 6, verticalAlign: 'middle', marginRight: 8 }} />MAX Маркетинг</h1>
