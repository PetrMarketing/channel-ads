...
const PLAN_META = {
  1: { features: ['1 месяц доступа ко всем функциям', 'Подписка на 1 канал', 'Поддержка 24/7'] },
  3: { features: ['3 месяца доступа на 1 канал', 'Все функции без ограничений', 'Скидка к месячному тарифу'] },
  6: { features: ['6 месяцев на 1 канал — полгода спокойствия', 'Все функции без ограничений', 'Заметная экономия'] },
  12: { features: ['12 месяцев на 1 канал — максимальная выгода', 'Все функции без ограничений', 'Скидка 30% к месячному'] },
};
